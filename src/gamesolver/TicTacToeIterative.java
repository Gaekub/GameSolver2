...
public class TicTacToeIterative {
    StateData sd;
    TicTacToeIterative[] stateList;
    TicTacToeIterative[] nextStates;
    
    TicTacToeIterative(StateData sdIn, TicTacToeIterative[] stateListIn){
        sd = sdIn;
    ...
    void getNextStates(){
        ...
        nextStates = new TicTacToeIterative[9];
            ...
            for(int j = 0; j<sd.data[i].length; j++){
                if(sd.data[i][j] == 0){
                    ...
                    if(x>=0){
                        ...
                        nextStates[nextNum] = new TicTacToeIterative(temp2, stateList);
